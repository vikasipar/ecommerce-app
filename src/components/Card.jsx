...
function Card(props) {
  ...
  return (
    <div className='w-[270px] h-[450px] flex-column mx-auto my-4 border-stone-200 p-7 border-2 shadow-xl rounded-md bg-rgba-white-80'>
        ...
        <button onClick={() => addToCartHandler(props.item)} className='w-full h-[40px] border-2 bg-stone-700 hover:bg-stone-800 mt-3 text-lg text-white uppercase'>Add To Cart</button>
    </div>
  )
}
